...
const getPostData = postId => axios.get(
...
const addPostToServer = post => axios.post(
  `${BASE_URL}/api/posts`,
  { post },
  { headers: { Authorization: `Bearer ${getAccessToken()}` } },
)
...
const addPostCommentToServer = (postId, postComment) => axios.post(
